...
/*   Updated: 2024/12/04 12:17:36 by jesuserr         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	print_sha512_digest(t_sha512_data *ssl_data)
{
	uint8_t	i;
	int8_t	j;
	uint8_t	*byte;
	...
	if (!ssl_data->args->quiet_mode && !ssl_data->args->reverse_output)
		ft_printf("SHA512 (\"%s\") = ", ssl_data->args->input_str);
